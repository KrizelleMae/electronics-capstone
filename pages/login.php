              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-5">Welcome to <br/> Repair and Sales Inventory!</h1>
                  </div>
                  <form class="user" role="form" action="processlogin.php" method="post">
                    ...
                    <button class="btn btn-primary btn-user btn-block mb-4" type="submit" name="btnlogin">LOGIN</button>
                    <hr>
                  <!-- <div class="text-center">
                ...
                <button type="button" class="btn btn-outline-primary btn-sm mb-4">Track Job Order Here!</button></a>
                </div>
                </form>
                </div>
