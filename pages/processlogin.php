...
//create some sql statement             
        $sql = "SELECT  ID,e.FIRST_NAME,e.LAST_NAME,e.GENDER,e.EMAIL,e.PHONE_NUMBER,j.JOB_TITLE, e.JOB_ID,l.PROVINCE,l.CITY,t.TYPE, e.EMPLOYEE_ID
        FROM  `users` u
        ...
        //IF theres a result
            if ( $result->num_rows > 0) {
                ...
                $_SESSION['JOB_ID'] = $found_user['JOB_ID'];
