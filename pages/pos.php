...
function pre_r($array){
    ...
    echo '</pre>';
          ...
          <div class="col-lg-12">
            ...
            <div class="card-header py-2">
              <div class="d-flex mt-1">
                ...
                <a href="job_order_payment.php" class="ml-auto"><button class=" btn btn-warning   ">Job Order Payment</button></a>
          </div>  
        </div>
        <!-- /.panel-heading -->
        <div class="card-body"> 
            ...
            <ul class="nav nav-tabs">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#printer" data-toggle="tab">Printer Related</a>
              </li>
              <li class="nav-item">
        ...
        <!-- TAB PANE AREA - ANG SUNOD KA TABS ARA SA TABPANE.PHP -->
            <?php include 'postabpane.php'; ?>
        <!-- END TAB PANE AREA - ANG SUNOD KA TABS ARA SA TABPANE.PHP -->

        <!-- Product Modal-->
        <div class="modal fade" data-backdrop="static" id=" " tabindex="-1" role="dialog" data-id="payment" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              ...
              <select class="form-control" onchange="selectJobOrder(value)"> 
              <?php
                $sql = "SELECT *
                FROM repairs";
        ...
        <script>
          function selectJobOrder(e) {
            // window.location.href = `?id=${e}`
            window.location.href = `job_order_payment.php?id=${e}`
          }
        </script>
  ...
  <!-- Close Modal -->
        ...
        <div class="card-header py-3 bg-white">
          ...
          <p>First select a product from the Product category before selecting a Customer.</p>
        </div>
