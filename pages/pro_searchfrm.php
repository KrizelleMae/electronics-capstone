...
<?php
          ...
          <center><div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
            ...
            <div class="card-body">
          <?php 
            $query = 'SELECT PRODUCT_ID, PRODUCT_CODE,SERIAL_NO, NAME,DESCRIPTION, COUNT(`QTY_STOCK`) AS "QTY_STOCK", COUNT(`ON_HAND`) AS "ON_HAND",PRICE, c.CNAME FROM product p join category c on p.CATEGORY_ID=c.CATEGORY_ID WHERE PRODUCT_CODE ='.$_GET['id'];
            $result = mysqli_query($db, $query) or die(mysqli_error($db));
