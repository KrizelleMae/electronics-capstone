    ...
    <div id="content-wrapper" class="d-flex flex-column ">
      ...
      <div id="content">
        ...
        <div class="sidebar-brand-icon rotate-n-15 text-primary mr-0">
          <i class="fas fa-laugh-wink"></i>
        </div>
        <div> <div class="sidebar-brand-text mx-3 text-primary text-uppercase">Repair Management System</div></div>
